//
//  AutoFindTableViewDataSource.swift
//  AutoFind
//
...
/*
 ...
 This is AutoFindTableViewDataSource responsible for data source of simple tableViews.
 
 You can easily add new datas to array by confirming your tableViewCell to AutoFindTableViewCell.
 
 */

public protocol AutoFindTableViewDelegate: class {
...
extension AutoFindTableViewDelegate {
    func tableView(cellForRowAt: IndexPath, cell: UITableViewCell) { }
    func tableView(willDisplay cellIndexPath: IndexPath, cell: UITableViewCell) { }
    func tableView(didEndDisplaying cellIndexPath: IndexPath, cell: UITableViewCell) { }
    func tableView(didSelectRowAt index: IndexPath) { }
...
public class AutoFindTableViewDataSource<T: AutoFindTableViewCell>: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    weak var delegate: AutoFindTableViewDelegate?
    
    public init(cellHeight: CGFloat?, items: [T.CellViewModel] = [], tableView: UITableView, delegate: AutoFindTableViewDelegate, animationType: CellAnimationType = .none) {
